...
if ($result->num_rows == 0) {
    ...
    $consulta= "INSERT INTO conversaciones_" . $administrador . "_" . $profesor."(cod_administrador, cod_usuario, mensaje, hora_envio, fecha, estado, desde)
     VALUES ('$administrador', '$profesor', '$texto', '$horaActual', '$fechaActual', 'no visto', '$administrador')"; 
    ...
    $resId = mysqli_fetch_assoc($res);
        ...
        $elemento = array('id' =>$resId['max_id'],'administrador' => $administrador, 'profesor' => $profesor, 'fecha' => $fechaActual, 'hora' => $horaActual, 'desde' => $administrador);
